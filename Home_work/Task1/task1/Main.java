...
public class Main {
    ...
    static void task3() {
        // Убираем 2 последних catch так как они унаследованны от первого,
        // так же не вижу смысла делать проброс в main, так как мы находимся в корне программы,
        // выше класса нет. Так же не вижу смысла пробрасывать FileNotFoundException в методе printSum.
